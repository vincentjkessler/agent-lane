...
- [`SUPPORTING_NORMATIVE.md`](SUPPORTING_NORMATIVE.md) — supporting normative material
- [`EVIDENCE_STATUS.md`](EVIDENCE_STATUS.md) — what is and is not proven
- [`REVIEW_GUIDE.md`](REVIEW_GUIDE.md) — external review path
- [`REVIEW_RESPONSE_TEMPLATE.md`](REVIEW_RESPONSE_TEMPLATE.md) — structured review response
- [`STATUS.json`](STATUS.json) — machine-readable candidate status
- [`schemas/`](schemas/) — candidate schemas

Implementation/product source is outside the scope of this public review repository.
