...
Run ID: bci-20260917-141819-14f35b0bfcd1
Run folder: bci/runs/bci-20260917-141819-14f35b0bfcd1/
...
Before releasing Task 1, publish exactly one immutable file:
  bci/runs/bci-20260917-141819-14f35b0bfcd1/plan-00.json

Schema:
{
  "schema": "bci.plan.v1",
  "runId": "bci-20260917-141819-14f35b0bfcd1",
  "revision": 0,
  "tasks": [
    {
      "task": 1,
...
- initial plan: bci/runs/bci-20260917-141819-14f35b0bfcd1/task-<two-digit task>-r00.json
- replacement after replan N: bci/runs/bci-20260917-141819-14f35b0bfcd1/task-<two-digit task>-rNN.json
